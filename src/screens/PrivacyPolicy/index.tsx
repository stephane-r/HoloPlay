      ...
      >
        ...
        <View style={styles.content}>
          ...
          <Text>
            ...
            <Text style={{ fontStyle: "italic" }}>HoloPlay</Text>{" "}
            {t("privacyPolicy.intro2")}{" "}
            <Text style={{ fontWeight: "bold" }}>Stéphane Richin</Text>
          </Text>
        ...
        <View style={styles.content}>
          ...
          <Text>
            {t("privacyPolicy.emailText1")}, {t("privacyPolicy.emailText2")}
          </Text>
          <Spacer height={5} />
          <TouchableHighlight
            onPress={() => Linking.openURL("mailto:contact@stephane-richin.fr")}
          >
            <Text style={{ color: colors.primary }}>
              contact@stephane-richin.fr
            </Text>
          </TouchableHighlight>
        </View>
        <View style={styles.content}>
          <Subheading style={styles.subheading}>
            {t("privacyPolicy.crashReportingTitle")}
          </Subheading>
        ...
        <View style={styles.content}>
          <Subheading style={styles.subheading}>
            {t("privacyPolicy.permissionsTitle")}
          </Subheading>
